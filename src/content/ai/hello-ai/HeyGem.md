...
今天主要分享的是轻量版的安装使用教程，我自己也是用的这本版本，因为可以节约很多空间，希望使用完整功能的到官网看文档安装完整版 [github](https://github.com/duixcom/Duix-Avatar)。  
...
![image_02.png](https://ymkit-1307887579.cos.ap-chengdu.myqcloud.com/img/image_02.webp)
